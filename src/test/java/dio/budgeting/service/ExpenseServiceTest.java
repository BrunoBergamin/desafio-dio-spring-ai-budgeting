...
class ExpenseServiceTest {
    ...
    void should_returnBudgetStatus_when_categoryHasBudget() {
        ...
        var created = new TransactionResponse(UUID.randomUUID(), "Mercado", new BigDecimal("50"), Category.GROCERIES, "Mercado", LocalDate.of(2026, 9, 10));
    ...
    void should_returnNullBudget_when_categoryHasNoBudget() {
        ...
        when(transactionService.create(any(), any())).thenReturn(
                new TransactionResponse(UUID.randomUUID(), "Uber", new BigDecimal("20"), Category.TRANSPORT, "Transporte", LocalDate.now()));
